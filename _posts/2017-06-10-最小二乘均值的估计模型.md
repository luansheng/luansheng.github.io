...
LS means 并不是很好理解，术语本身就会令人迷惑。[Searle（1980）](#Searle)年详细的讨论了对于各种因子、嵌套和协方差模型，该如何定义最小二乘均值。Searle建议利用术语"predicted marginal means"来代替"least-squares means",可能更为合理。
